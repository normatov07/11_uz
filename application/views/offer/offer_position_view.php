...
?>
<form id="message_form" method="post" action="<?=($this->isModerator())?$offer->url_position:$offer->url_payment_position;?>" class="position_form">
...
<div class="offer_message bmar">
	...
	<h1><?=@$title?></h1>
    <p>Ваше объявление будет поднято наверх в списке обычных объявлений.<br />
	<h2><b class="offer_type"><?=$offer->type->title?>:</b> <?=$offer->title?></h2>
	<table>
		<tbody>
			<tr>
				<th>Разовое <?=UTF8::strtolower(@$action)?> объявления. </th>
	...
	<div class="instructions">
		<p>— Объявление будет поднято наверх в списке обычных объявлений.</p>
