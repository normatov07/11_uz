...
?>
<form id="message_form" method="post" action="<?=($this->isModerator())?$offer->url_mark:$offer->url_payment_mark;?>" class="mark_form">
...
<div class="offer_message bmar">
	...
	<h1><?=@$title?></h1>
    <p>Ваше объявление будет выделено цветом в списке обычных объявлений.<br />
...
//		}
		...
		if($amount): ?>	
			...
			<script type="text/javascript">tariff = <?echo number_format($tariff/$amount, 2, '.', '')?></script>
<?php	endif;?>
				</th>
